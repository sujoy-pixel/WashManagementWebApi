...
namespace Erp.Application.MascoWash.Handlers
{
    public class BatchWishQCDataHandler : IRequestHandler<BatchWishQCDataQuery, BatchWiseQCDataResult>
    {
        private readonly ISaveDataList _setupService;
        ...
        public async Task<BatchWiseQCDataResult> Handle(
            BatchWishQCDataQuery request,
            CancellationToken cancellationToken)
        {
            return await _setupService.GetBatchWiseQCDataWithSizes(request.batchNo);
        }
    }
}